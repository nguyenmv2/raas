...
import com.github.nguyenmv2.raas.email.sender.DummyEmailSender
import com.github.nguyenmv2.raas.infrastructure.Doobie._
import com.github.nguyenmv2.raas.infrastructure.Json._
import com.github.nguyenmv2.raas.passwordreset.PasswordResetApi.{ForgotPassword_IN, ForgotPassword_OUT, PasswordReset_IN, PasswordReset_OUT}
...
class PasswordResetApiTest extends BaseTest with TestEmbeddedPostgres with Eventually {
  ...
  def codeSentToEmail(email: String): String = {
    ...
    val emailData = DummyEmailSender
      .findSentEmail(email, "SoftwareMill Raas password reset")
